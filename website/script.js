...
const translations = {
  en: {
    ...
    launchTitle: "Join CruizX and drive with people who match your style.",
    launchBody:
      "Get launch updates, convoy invites, and early-access features built for your kind of driving.",
  ...
  nb: {
    ...
    launchEyebrow: "Lansering",
    launchTitle: "Bli med i CruizX og kjør med folk som matcher kjørestilen din.",
    launchBody:
      "Få lanseringsoppdateringer, konvoiinvitasjoner og tidlig tilgang til funksjoner bygget for denne typen kjøring.",
  ...
  da: {
    ...
    launchTitle: "Bliv en del af CruizX og kor med folk, der matcher din kørestil.",
    launchBody:
      "Få lanceringsopdateringer, konvojinvitationer og tidlig adgang til funktioner bygget til denne type kørsel.",
    ...
    launchTitle: "Liity CruizXiin ja aja ihmisten kanssa, jotka sopivat ajotyyliisi.",
    launchBody:
      "Saat julkaisu-uutiset, konvojikutsut ja varhaisen pasyn ominaisuuksiin, jotka on rakennettu taman tyyppiseen ajoon.",
  ...
  fr: {
    ...
    launchTitle: "Rejoignez CruizX et roulez avec des personnes qui partagent votre style.",
    launchBody:
      "Recevez les mises a jour de lancement, des invitations convoi et un acces anticipe aux fonctions adaptees a votre type de conduite.",
