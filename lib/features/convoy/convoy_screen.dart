  ...
  Future<void> _showSignInDialog(
    ...
    if (!authService.supportsRealtimeBackend) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(l10n.convoyRealtimeBackendMissing)),
      );
      return;
    }

    _signInEmailController.text = '';
    _signInCodeController.text = '';
    var otpSent = false;
    var createMode = createAccount;
        ...
        return StatefulBuilder(
          builder: (context, setStateDialog) {
            return AlertDialog(
              title: Text(
                createMode
                    ? l10n.signUpEmailDialogTitle
                    : l10n.signInEmailDialogTitle,
              ),
              content: Column(
                ...
                children: [
                  ...
                  if (otpSent) ...[
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        labelText: l10n.signInOtpFieldLabel,
                  ...
                  if (!otpSent)
                    Align(
                      ...
                      child: TextButton(
                        ...
                        child: Text(
                          createMode
                              ? l10n.signUpHaveAccountAction
                              : l10n.signUpNoAccountAction,
                        ),
                      ),
                    ),
                ],
                  ...
                  onPressed: () async {
                    try {
                      ...
                      await authService.verifyOtp(
                        code: _signInCodeController.text,
                      );
                      if (!context.mounted) {
                        return;
                      }
                      ...
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(content: Text(l10n.signInOtpInvalid)),
                        );
                      }
                    }
                  },
